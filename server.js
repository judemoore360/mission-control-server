...
// Upstash returns URL-encoded strings — decode them
...
googleTokens = tokens;
res.send(`<h2 style="font-family:sans-serif;color:green">✅ Gmail connected!</h2> <p style="font-family:sans-serif;margin:16px 0">Now do this one time to make it permanent:</p> <ol style="font-family:sans-serif;line-height:2"> <li>Copy the refresh token below</li> <li>Go to Render → your service → Environment</li> <li>Add new variable: <strong>GOOGLE_REFRESH_TOKEN</strong></li> <li>Paste the token as the value and save</li> </ol> <p style="font-family:sans-serif;margin:16px 0"><strong>Your refresh token:</strong></p> <textarea style="width:100%;height:80px;font-size:12px;padding:8px">${tokens.refresh_token}</textarea>`);
